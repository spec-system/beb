...
const dept = (
  ...
  return {
    ...
    posterFile: opts.posterFile ?? null,
    posterReviewed: opts.posterReviewed ?? false,
    reportReviewed: opts.reportReviewed ?? false,
    draftSavedAt: opts.draftSavedAt ?? '',
...
export const SEED_DEPT: DeptProgramRecord[] = [
  dept('20231234', '신약개발 연구 세미나', '최종 승인', '김희진', '1학기', 10, {
    ...
    posterFile: { name: '신약개발_포스터.pdf', size: 320000, uploadedAt: '2026-05-16T10:00:00' },
    ...
    history: [
      h('신청 완료', '김지혜', 'STUDENT', '2026-03-02T09:00:00'),
      h('담당교수 승인', '김희진', 'PROFESSOR', '2026-03-05T11:00:00'),
      h('신청 승인됨', '이도현', 'HEAD', '2026-03-06T09:00:00'),
      h('포스터 업로드', '김지혜', 'STUDENT', '2026-05-16T10:00:00'),
      h('결과 보고서 제출', '김지혜', 'STUDENT', '2026-05-18T10:00:00'),
      h('포스터 심사 완료', '이도현', 'HEAD', '2026-05-19T13:00:00'),
      h('결과 보고서 심사 완료', '이도현', 'HEAD', '2026-05-19T13:10:00'),
      h('최종 승인', '이도현', 'HEAD', '2026-05-20T14:20:00'),
    ],
  }),
  dept('20231236', '지역사회 약국 실무실습', '최종 검토중', '이도현', '1학기', 20, {
    posterFile: { name: '약국실습_포스터.pdf', size: 300000, uploadedAt: '2026-06-08T16:00:00' },
    ...
    history: [
      h('신청 완료', '박소영', 'STUDENT', '2026-03-03T09:00:00'),
      h('담당교수 승인', '이도현', 'PROFESSOR', '2026-03-06T10:00:00'),
      h('신청 승인됨', '이도현', 'HEAD', '2026-03-07T10:00:00'),
      h('포스터 업로드', '박소영', 'STUDENT', '2026-06-08T16:00:00'),
      h('결과 보고서 제출', '박소영', 'STUDENT', '2026-06-09T16:00:00'),
      h('포스터 심사 완료', '이도현', 'HEAD', '2026-06-10T09:15:00'),
    ],
  }),
  dept('20231237', '임상약학 케이스 스터디', '담당교수 승인', '김희진', '1학기', 15, {
    lastUpdate: '2026-04-02T11:30:00',
    history: [
      h('신청 완료', '정민호', 'STUDENT', '2026-03-30T09:00:00'),
      h('담당교수 승인', '김희진', 'PROFESSOR', '2026-04-02T11:30:00'),
    ],
  }),
  dept('20231238', '제약 GMP 현장 탐방', '신청 완료', '박선영', '2학기', 8, {
    lastUpdate: '2026-09-01T09:00:00',
    history: [h('신청 완료', '최유나', 'STUDENT', '2026-09-01T09:00:00')],
  }),
  dept('20221201', '천연물 신약 탐색 프로젝트', '최종 승인', '박선영', '1학기', 12, {
    posterFile: { name: '천연물_포스터.pdf', size: 280000, uploadedAt: '2026-05-24T10:00:00' },
    ...
    history: [
      h('신청 완료', '한서진', 'STUDENT', '2026-03-02T09:00:00'),
      h('담당교수 승인', '박선영', 'PROFESSOR', '2026-03-04T10:00:00'),
      h('신청 승인됨', '이도현', 'HEAD', '2026-03-05T10:00:00'),
      h('포스터 업로드', '한서진', 'STUDENT', '2026-05-24T10:00:00'),
      h('결과 보고서 제출', '한서진', 'STUDENT', '2026-05-25T10:00:00'),
      h('포스터 심사 완료', '이도현', 'HEAD', '2026-05-26T13:00:00'),
      h('결과 보고서 심사 완료', '이도현', 'HEAD', '2026-05-26T13:10:00'),
      h('최종 승인', '이도현', 'HEAD', '2026-05-28T15:00:00'),
    ],
  }),
  dept('20221203', '약물상담 롤플레이 워크숍', '결과 보고서 검토 중', '김희진', '2학기', 10, {
    reportFile: { name: '롤플레이_보고서.pdf', size: 390000, uploadedAt: '2026-10-10T10:00:00' },
    lastUpdate: '2026-10-12T13:00:00',
    history: [
      h('신청 완료', '윤채원', 'STUDENT', '2026-09-05T09:00:00'),
      h('담당교수 승인', '김희진', 'PROFESSOR', '2026-09-08T10:00:00'),
      h('신청 승인됨', '이도현', 'HEAD', '2026-09-09T10:00:00'),
      h('결과 보고서 제출', '윤채원', 'STUDENT', '2026-10-10T10:00:00'),
    ],
  }),
  dept('20241101', '기초 약리학 스터디그룹', '(담당교수에게) 반려됨', '박선영', '1학기', 6, {
    lastUpdate: '2026-04-15T10:00:00',
    history: [
      h('신청 완료', '신아름', 'STUDENT', '2026-04-10T09:00:00'),
      h('(담당교수에게) 반려됨', '박선영', 'PROFESSOR', '2026-04-15T10:00:00', '계획서 내용 보완 필요 (목표·일정 구체화).'),
    ],
  }),
];
