...
export const SEED_VOLUNTEER: VolunteerRecord[] = [
  vol('20231234', '어르신 복약지도 봉사', '승인', 8, 22, {
    ...
    history: [
      ...
      h('승인', '이도현', 'HEAD', '2026-10-02T11:00:00'),
    ],
  }),
  vol('20231235', '지역아동센터 건강교실', '검토중', 6, 6, {
  ...
  vol('20231236', '보건소 금연클리닉 지원', '승인', 12, 24, {
    ...
    history: [
      ...
      h('승인', '이도현', 'HEAD', '2026-06-03T13:00:00'),
    ],
  }),
  vol('20221201', '헌혈 캠페인 운영 봉사', '승인', 4, 10, {
    ...
    history: [
      ...
      h('승인', '이도현', 'HEAD', '2026-05-12T10:00:00'),
    ],
  }),
